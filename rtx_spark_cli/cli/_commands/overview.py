"""``rtx-spark-cli overview`` — read-only descriptive snapshot of the agent.
...
:mod:`rtx_spark_cli.cli._commands.cli`).
...
from rtx_spark_cli.cli._commands.whoami import report
