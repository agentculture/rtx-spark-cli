...
from rtx_spark_cli import __version__
from rtx_spark_cli.cli._errors import EXIT_USER_ERROR, CliError
from rtx_spark_cli.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/rtx-spark-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from rtx_spark_cli.cli._commands import cli as _cli_group
    from rtx_spark_cli.cli._commands import doctor as _doctor_cmd
    from rtx_spark_cli.cli._commands import explain as _explain_cmd
    from rtx_spark_cli.cli._commands import learn as _learn_cmd
    from rtx_spark_cli.cli._commands import overview as _overview_cmd
    from rtx_spark_cli.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="rtx-spark-cli",
        description="rtx-spark-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
    ...
    #   from rtx_spark_cli.cli._commands import my_noun as _my_noun_group
