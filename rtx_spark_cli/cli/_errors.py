...
Every failure inside rtx-spark-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`rtx_spark_cli.cli._output`,
...
# Exit-code policy. Documented in ``rtx-spark-cli learn`` output.
# 0      = success
